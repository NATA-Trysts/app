...
import { CHARACTER_CONFIG_VALUE_MAPPING, MATERIAL_MAPPING } from '@/libs/constants'
...
export const OtherCharacter = ({
  ...
  const { scene, materials, animations } = useGLTF(`/models/character-v4.glb`) as GLTFResult

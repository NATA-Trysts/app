...
type BuilderState = {
  ...
  setSubCategoryItems: (subCategoryItems: SubCategoryItem[]) => void

  selectedSubCategoryItem: SubCategoryItem
  setSelectedSubCategoryItem: (selectedSubCategoryItem: SubCategoryItem) => void
}

export const useBuilderStore = create<BuilderState>((set) => ({
  subCategoryItems: subCategoryList,
  setSubCategoryItems: (subCategoryItems: SubCategoryItem[]) => set(() => ({ subCategoryItems })),

  selectedSubCategoryItem: subCategoryList[0],
  setSelectedSubCategoryItem: (selectedSubCategoryItem: SubCategoryItem) => set(() => ({ selectedSubCategoryItem })),
}))
